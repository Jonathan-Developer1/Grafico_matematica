function mostrarDado() {
  ...
  for (let i = 1; i <= 10; i++) {
    ...
    const valorAtual = capital * Math.pow(1 + taxa, tempoAtual) + aporte*(Math.pow(1 + taxa, tempoAtual )-1)/taxa;
    ...
    document.getElementById("res-diferenca").innerText = "Diferença (ganho real): R$ " + diferenca.toFixed(2);
